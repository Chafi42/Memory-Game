...
<div class="bg-[#F5F5F5] py-12 flex flex-col">
    ...
    <section class="flex-grow mt-12">
      <form @submit.prevent="sendEmail" class="max-w-2xl mx-auto space-y-8">
        <div>
          <label htmlFor="name"
          class="block text-[#222222] font-bold"
            >Nom</label
          >
          <input
            type="text"
        ...
        <div>
          <label htmlFor="email" class="block text-[#222222] font-bold"
            >Email</label
          >
          <input
      v-model="formData.email"
        ...
        <div>
          <label htmlFor="message" class="block text-[#222222] font-bold"
            >Message</label
          >
          <textarea
            required
